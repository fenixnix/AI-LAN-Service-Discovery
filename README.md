...
<p align="center">
  <button id="lang-toggle" onclick="toggleLanguage()" style="padding: 8px 16px; border: 1px solid #ddd; border-radius: 4px; background: #f8f8f8; cursor: pointer;">English</button>
</p>
...
<p align="center">
  <a href="https://github.com/ai-server-discover/ai-server-discover/releases">
    <img src="https://img.shields.io/github/v/release/ai-server-discover/ai-server-discover?include_prereleases&label=release" alt="Release"/>
  </a>
